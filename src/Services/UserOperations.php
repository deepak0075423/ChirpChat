...
class UserOperations {
    ...
    public function getFriendRequestNoti($notificationFriendRequest) {
        $arr = [];
        forEach($notificationFriendRequest as $notification) {
            $arr[] = [
                'userId' => $notification->getId(),
                'firstname' => $notification->getFromRequest()->getFirstName(),
                'lastname' => $notification->getFromRequest()->getLastName(),
                'img' => $notification->getFromRequest()->getImg(),
                'status' => 'none'
            ];
        }
        return $arr;
    ...
    public function getSearchList(array $users) {
        $arr = [];
        forEach($users as $user) {
            $arr[] = [
                'id' => $user->getId(),
